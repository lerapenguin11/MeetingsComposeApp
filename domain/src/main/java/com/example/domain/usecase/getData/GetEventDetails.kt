...
class GetEventDetails : KoinComponent {
    ...
    private val eventPrepared: Flow<com.example.model.eventDetails.MeetingDetails> =
    ...
    fun execute(): Flow<com.example.model.eventDetails.MeetingDetails> = eventPrepared
