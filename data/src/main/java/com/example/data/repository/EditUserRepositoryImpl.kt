...
class EditUserRepositoryImpl(private val context: Context) : EditUserRepository {
    ...
    override fun getUserInfoForEdit(token: com.example.model.token.AutToken): Flow<com.example.model.editUser.EditUserInfo> {
        return flow {
    ...
    private fun userInfoForEditMock(): com.example.model.editUser.EditUserInfo {
        return com.example.model.editUser.EditUserInfo(
