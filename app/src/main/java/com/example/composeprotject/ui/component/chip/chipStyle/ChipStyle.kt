...
class ChipStyle(
    ...
    override fun chipSelectedColor(variant: ChipColor): Map<String, Color> {
        return when (variant) {
            ChipColor.TRUE -> paramsChip.selectedColor
            ChipColor.FALSE -> paramsChip.notSelectedColor
        }
    }
...
private interface ChipStyleVariant {
    ...
    fun chipSelectedColor(variant: ChipColor): Map<String, Color>
